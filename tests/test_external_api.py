...
def test_successful_response_fh(stock_test_response):
...
def test_multiple_stocks(stock_test_response):
    """Тест обработки нескольких акций"""
    # test_data = {
    #     "c": 150.0, "d": 1.5, "dp": 1.01,
    #     "h": 152.0, "l": 149.0, "o": 151.0, "pc": 148.5
    # }
